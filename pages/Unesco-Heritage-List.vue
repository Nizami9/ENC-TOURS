  ...
  <NuxtLayout>
    <div>
      ...
      <div class="text-center">
        ...
        <div
          class="mainSection flex w-10/12 m-auto mt-10 uppercase mb-2"
          v-motion
          :initial="{
            opacity: 0,
            y: 100,
        ...
        >
          <div class="w-1/3 uppercase sectionDiv">
            <div class="pb-2">
              <img
                src="@/assets/images/baku.jpeg"
...
.parallax::before {
  ...
  right: 0;
  bottom: 0;
  background-image: url("@/assets/images/unesco.png");
