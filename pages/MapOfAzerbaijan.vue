      ...
      <div class="text-center">
        ...
        <div class="flex w-1/2 m-auto border-b border-orange-400">
          <div
            ...
            class="w-full m-6 flex m-auto"
          >
            <img
              src="@/assets/images/map.jpeg"
              class="w-full m-auto flex"
              alt="mapofazerbaijan"
            />
          </div>
        </div>
...
.parallax::before {
  ...
  right: 0;
  bottom: 0;
  background-image: url("@/assets/images/map5.jpeg");
