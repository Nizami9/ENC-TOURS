  ...
  <NuxtLayout>
    <div>
      <div class="relative z-0 w-full parallax">
        ...
        >
          <p class="text-7xl uppercase font-semibold">Hotels in Lankaran</p>
        ...
        <div class="w-10/12 m-auto mt-10">
          ...
          >
            <p class="border-b-2 pb-2 border-orange-400">
              Khan Lankaran Hotel 4*
            </p>
            <div class="flex p-8 pl-0">
              <img
                src="@/assets/images/khan2.jpeg"
...
.parallax::before {
  ...
  right: 0;
  bottom: 0;
  background-image: url("@/assets/images/lankaran.jpeg");
