          ...
          <div class="w-10/12 m-auto pt-10 pb-10">
            ...
            <div class="mb-6">
              <div
                ...
                class="flex border-b pb-2 border-black justify-between duration-500 transition-all cursor-pointer mt-10"
              >
                <p class="text mt-1 text-lg">{{ $t("az10D2") }}</p>
                <img
                  src="@/assets/images/plus-button.png"
                  class="plusButton w-8"
                  alt=""
            ...
            <div class="mb-6">
              <div
                ...
                class="flex border-b pb-2 border-black justify-between duration-500 transition-all cursor-pointer mt-10"
              >
                <p class="text mt-1 text-lg">{{ $t("ExplD3") }}</p>
                <img
                  src="@/assets/images/plus-button.png"
                  class="plusButton w-8"
                  alt=""
            ...
            <div class="mb-6">
              <div
                ...
                class="flex border-b pb-2 border-black justify-between duration-500 transition-all cursor-pointer mt-10"
              >
                <p class="text mt-1 text-lg">{{ $t("ExplD4") }}</p>
                <img
                  src="@/assets/images/plus-button.png"
                  class="plusButton w-8"
                  alt=""
            ...
            <div class="mb-6">
              <div
                ...
                class="flex border-b pb-2 border-black justify-between duration-500 transition-all cursor-pointer mt-10"
              >
                <p class="text mt-1 text-lg">{{ $t("ExplD5") }}</p>
                <img
                  src="@/assets/images/plus-button.png"
                  class="plusButton w-8"
                  alt=""
            ...
            <div class="mb-6">
              <div
                ...
                class="flex border-b pb-2 border-black justify-between duration-500 transition-all cursor-pointer mt-10"
              >
                <p class="text mt-1 text-lg">{{ $t("ExplD8") }}</p>
                <img
                  src="@/assets/images/plus-button.png"
                  class="plusButton w-8"
                  alt=""
            ...
            <div class="mb-6">
              <div
                ...
                class="flex border-b pb-2 border-black justify-between duration-500 transition-all cursor-pointer mt-10"
              >
                <p class="text mt-1 text-lg">{{ $t("ExplD9") }}</p>
                <img
                  src="@/assets/images/plus-button.png"
                  class="plusButton w-8"
                  alt=""
