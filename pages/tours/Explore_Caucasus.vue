          ...
          <div class="w-10/12 m-auto pt-10 pb-10">
            ...
            <div class="mb-6">
              <div
                ...
                class="flex border-b pb-2 border-black justify-between duration-500 transition-all cursor-pointer mt-10"
              >
                <p class="text mt-1 text-lg">DAY 4: BAKU – SHAMAKHI – SHEKI</p>
                <img
                  src="@/assets/images/plus-button.png"
                  class="plusButton w-8"
                  alt=""
            ...
            <div class="mb-6">
              <div
                ...
                class="flex border-b pb-2 border-black justify-between duration-500 transition-all cursor-pointer mt-10"
              >
                <p class="text mt-1 text-lg">DAY 5: SHEKI – KISH – SHEKI</p>
                <img
                  src="@/assets/images/plus-button.png"
                  class="plusButton w-8"
                  alt=""
            ...
            <div class="mb-6">
              <div
                ...
                class="flex border-b pb-2 border-black justify-between duration-500 transition-all cursor-pointer mt-10"
              >
                <p class="text mt-1 text-lg">DAY 6: TELAVI – MTSKHETA – GUDAURI</p>
                <img
                  src="@/assets/images/plus-button.png"
                  class="plusButton w-8"
                  alt=""
            ...
            <div class="mb-6">
              <div
                ...
                class="flex border-b pb-2 border-black justify-between duration-500 transition-all cursor-pointer mt-10"
              >
                <p class="text mt-1 text-lg">DAY 7: GUDAURI – KAZBEGI – TBILISI</p>
                <img
                  src="@/assets/images/plus-button.png"
                  class="plusButton w-8"
                  alt=""
            ...
            <div class="mb-6">
              <div
                ...
                class="flex border-b pb-2 border-black justify-between duration-500 transition-all cursor-pointer mt-10"
              >
                <p class="text mt-1 text-lg">DAY 8: TBILISI</p>
                <img
                  src="@/assets/images/plus-button.png"
                  class="plusButton w-8"
                  alt=""
            ...
            <div class="mb-6">
              <div
                ...
                class="flex border-b pb-2 border-black justify-between duration-500 transition-all cursor-pointer mt-10"
              >
                <p class="text mt-1 text-lg">DAY 9: TBILISI – DEPARTURE</p>
                <img
                  src="@/assets/images/plus-button.png"
                  class="plusButton w-8"
                  alt=""
