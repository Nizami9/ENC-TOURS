        ...
        <div class="mainSection w-10/12 m-auto mt-10">
          ...
          >
            <p class="text-color border-b-2 pb-2 border-gray-400">
              Park Chalet, Shahdag, Autograph Collection 4*
            </p>
            <div class="eachMuseum flex p-8 pl-0">
              <img
                src="@/assets/images/shahdag1.jpeg"
          ...
          >
            <p class="text-color border-b-2 pb-2 border-gray-400">
              P.I.K. Palace, Shahdag, Autograph Collection 5*
            </p>
            <div class="eachMuseum flex p-8 pl-0">
              <img
...
.parallax::before {
  ...
  right: 0;
  bottom: 0;
  background-image: url("@/assets/images/shahdag.jpeg");
  background-size: cover;
