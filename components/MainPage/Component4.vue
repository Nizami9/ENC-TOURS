<template>
  <div class="w-full mb-14">
    <div>
      <div class="w-10/12 m-auto mt-6 font-light text-5xl">
      ...
      <div class="text-center text-gray-600 w-10/12 m-auto mb-10">
        ...
        <p>
          From the picturesque to the picture perfect, our vast collection of
          Trails forms the canvas of your travel needs.
        </p>
      </div>
    </div>
